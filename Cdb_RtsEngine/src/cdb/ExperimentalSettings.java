...
public class ExperimentalSettings {
	...
	public enum Backend {POSTGRES,mysql ,VERTICA, MAIN_MEMORY};
	...
	public int rowSampleSize = 7000000; 							// ignore for basic tests

	public boolean noAggregateQueryOptimization = true; 	// true = no optimizations
	public boolean optimizeAll = true; 					// false = apply all optimizations
	...
	public int maxDBConnections = 50;						// OPT4: actual is double; max POSTGRES = 100
	...
	public String logFile = null;
                //"/home/himos/Public/exp.log";							// log file for profiling, set if you want
															// else goes to stdout
	...
	public boolean makeGraphs=false;								// whether to make graphs
	public Backend backend;									// what backend to use
	public boolean normalizeDistributions = false;			// whether to normalize distribution
	...
	public long mainMemoryNumRows = 70000;					// number of rows in the table
	...
	//public String shared_buff="32MB";						
                ...
                // New Parameters Added by Himos
	public boolean CorrelationDetection= true;                  //Detect the correlated Dims
        public AggregateFunctions Globalfunc=AggregateFunctions.AVG; //Which function want to test
        public int DimSelectvity=0;
        public int Kviews=10;
        public  String TestData="seedb_e2e_test";
        public int extime=0;
        public int Sela_shallow=1;
        public int Compute_Cost=0;
