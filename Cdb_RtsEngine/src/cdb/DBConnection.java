...
public class DBConnection {
	public static String[] supportedDatabases = new String[] {"PostgreSQL","mysql", "vertica"};
	...
	public boolean connectToDatabase(String database, String databaseType, 
		...
		try {
			if (databaseType.equalsIgnoreCase("PostgreSQL")) {
				...
				Class.forName("com." + databaseType + ".jdbc.Driver");
		...
		try {
			...
			if (databaseType.equalsIgnoreCase("PostgreSQL")) {
				//stmt.execute("select count(*) from olympicathletes");
